  ...
  SepaPaymentInfo.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this._painFormat === 'pain.001.001.09') {
        ...
        r(pstl, 'StrtNm', this[pullFrom + 'StreetName']);
        r(pstl, 'BldgNb', this[pullFrom + 'BuildingNumber']);
        r(pstl, 'BldgNm', this[pullFrom + 'BuildingName']);
        r(pstl, 'PstCd', this[pullFrom + 'PostCode']);
        r(pstl, 'TwnNm', this[pullFrom + 'TownName']);
        r(pstl, 'CtrySubDvsn', this[pullFrom + 'CountrySubDivision']);
