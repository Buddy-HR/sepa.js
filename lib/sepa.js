...
(function(exports) {
  ...
  SepaDocument.prototype = {
    ...
    createPaymentInfo: function() {
      return new SepaPaymentInfo(this._painFormat, this._paymentType);
    },
   ...
   */
  function SepaPaymentInfo(painFormat,paymentType) {
    this._painFormat = painFormat;
  ...
  function SepaTransaction(painFormat,paymentType,currency) {
    this._painFormat = painFormat;
